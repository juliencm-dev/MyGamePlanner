...
export function AvatarUpdateButton({ children, className }: { className?: string; children: React.ReactNode }) {
  return (
    <div className={cn(className, "relative cursor-pointer w-fit h-fit group")}>
      {children}
